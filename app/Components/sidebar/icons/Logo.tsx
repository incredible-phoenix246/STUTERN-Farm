...
function Logo({ fill = '#111', ...rest }) {
  return (
    <svg width={40} height={40} fill="none" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path d="M22.5 32.5h10V35h-10v-2.5zm0-5h15V30h-15v-2.5zm0-5h15V25h-15v-2.5z" fill={fill} />
      <path
